...
/// </summary>
public class NorthMacedoniaNationalIdValidator : INationalIdValidator
{
    /// <inheritdoc/>
    public string CountryCode => "MK";

    /// <summary>
    /// Validates the North Macedonia EMBG.
    /// </summary>
    ...
    /// <summary>
    /// Validates the North Macedonia EMBG (Static).
    /// </summary>
    /// <param name="nationalId">The ID to validate.</param>
    /// <returns>A <see cref="ValidationResult"/> indicating success or failure.</returns>
    public static ValidationResult ValidateStatic(string? nationalId)
    {
        ...
        {
            // Remainder 1 is invalid in JMBG/EMBG
