...
/// </summary>
public class CentralAfricanRepublicIbanValidator : IIbanValidator
{
    public string CountryCode => "CF";
    private const int IbanLength = 27;
    private const string CountryCodeVal = "CF";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = CentralAfricanRepublicBbanValidator.Validate(normalized.Substring(4));
