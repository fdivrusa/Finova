...
/// <summary>
/// Validator for Sao Tome and Principe BBAN.
/// Format: 21 digits.
/// </summary>
public class SaoTomeAndPrincipeBbanValidator : IBbanValidator
{
    ...
    public BbanDetails? ParseDetails(string? bban)
    {
        ...
        // Sao Tome and Principe: Bank(4) + Branch(4) + Account(11) + Key(2)
