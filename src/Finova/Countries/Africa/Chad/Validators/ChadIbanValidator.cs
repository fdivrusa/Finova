...
/// </summary>
public class ChadIbanValidator : IIbanValidator
{
    public string CountryCode => "TD";
    private const int IbanLength = 27;
    private const string CountryCodeVal = "TD";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = ChadBbanValidator.Validate(normalized.Substring(4));
