...
/// </summary>
public class ComorosIbanValidator : IIbanValidator
{
    public string CountryCode => "KM";
    private const int IbanLength = 27;
    private const string CountryCodeVal = "KM";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = ComorosBbanValidator.Validate(normalized.Substring(4));
