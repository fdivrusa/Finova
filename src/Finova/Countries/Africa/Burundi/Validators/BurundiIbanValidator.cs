...
/// </summary>
public class BurundiIbanValidator : IIbanValidator
{
    public string CountryCode => "BI";
    private const int IbanLength = 27;
    private const string CountryCodeVal = "BI";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = BurundiBbanValidator.Validate(normalized.Substring(4));
