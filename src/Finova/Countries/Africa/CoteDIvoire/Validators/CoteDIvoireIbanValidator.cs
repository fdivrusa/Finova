...
/// </summary>
public class CoteDIvoireIbanValidator : IIbanValidator
{
    public string CountryCode => "CI";
    private const int IbanLength = 28;
    private const string CountryCodeVal = "CI";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = CoteDIvoireBbanValidator.Validate(normalized.Substring(4));
