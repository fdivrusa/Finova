...
/// </summary>
public class GuineaBissauIbanValidator : IIbanValidator
{
    public string CountryCode => "GW";
    private const int IbanLength = 28;
    private const string CountryCodeVal = "GW";
    ...
    public static ValidationResult ValidateIban([NotNullWhen(true)] string? iban)
    {
        ...
        var bbanResult = GuineaBissauBbanValidator.Validate(normalized.Substring(4));
