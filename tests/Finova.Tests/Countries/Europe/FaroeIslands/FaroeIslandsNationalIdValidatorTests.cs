...
public class FaroeIslandsNationalIdValidatorTests
{
    private readonly FaroeIslandsNationalIdValidator _validator = new();

    [Theory]
    [InlineData("010150124")]
    public void Validate_ValidPtal_ReturnsSuccess(string? input)
    {
    ...
    [Theory]
    [InlineData("010150125")] // Invalid checksum
    ...
    {
        var result = _validator.Parse(" 010150124 ");
        result.Should().Be("010150124");
    }
