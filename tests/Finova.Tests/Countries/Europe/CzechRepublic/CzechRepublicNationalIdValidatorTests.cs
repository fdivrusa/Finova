...
namespace Finova.Tests.Countries.Europe.CzechRepublic;

public class CzechRepublicNationalIdValidatorTests
{
    private readonly CzechRepublicNationalIdValidator _validator = new();
