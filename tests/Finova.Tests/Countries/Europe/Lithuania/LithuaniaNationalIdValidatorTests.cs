...
public class LithuaniaNationalIdValidatorTests
{
    private readonly LithuaniaNationalIdValidator _validator = new();

    [Theory]
    [InlineData("37605030299")] // Calculated valid
    public void Validate_ValidAsmensKodas_ReturnsSuccess(string id)
    {
