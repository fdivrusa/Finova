...
public class SwitzerlandNationalIdValidatorTests
{
    private readonly SwitzerlandNationalIdValidator _validator = new();

    [Theory]
    [InlineData("756.1234.5678.97")] // Valid with dots
    [InlineData("7561234567897")]    // Valid without dots
    public void Validate_ValidAhv_ReturnsSuccess(string id)
    {
    ...
    [Theory]
    [InlineData("7561234567890")] // Invalid Checksum (Should be 7)
