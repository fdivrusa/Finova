...
namespace Finova.Tests.Core.Validators
{
    public class PaymentCardValidatorTests
    {
        ...
        {
            PaymentCardValidator.IsValidLuhn(cardNumber).Should().BeTrue();
        ...
        {
            PaymentCardValidator.IsValidLuhn(cardNumber).Should().BeFalse();
        }
        ...
        public void IsValidLuhn_WithAllZeros_PassesLuhnButUnlikely()
        {
            ...
            PaymentCardValidator.IsValidLuhn("0000000000000000").Should().BeTrue();
        }
        ...
        public void IsValidLuhn_WithSingleDigit_PassesLuhnCheck()
        {
            ...
            PaymentCardValidator.IsValidLuhn("0").Should().BeTrue();
        }
        ...
        public void IPaymentCardValidator_IsValidLuhn_DelegatesToStaticMethod()
        {
            ...
            var staticResult = PaymentCardValidator.IsValidLuhn(cardNumber);
        ...
        public void IntegrationTest_ValidateCompleteCard(string cardNumber, PaymentCardBrand expectedBrand, bool shouldBeValidLuhn)
        {
            ...
            PaymentCardValidator.IsValidLuhn(cardNumber).Should().Be(shouldBeValidLuhn);
