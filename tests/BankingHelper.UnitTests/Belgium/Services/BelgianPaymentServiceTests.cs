...
namespace BankingHelper.UnitTests.Belgium.Services
{
    public class BelgianPaymentServiceTests
    {
        private readonly BelgianPaymentService _service;

        public BelgianPaymentServiceTests()
        {
            _service = new BelgianPaymentService();
        }
